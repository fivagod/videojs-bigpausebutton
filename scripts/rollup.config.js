...
const builds = [{
  ...
  input: 'src/plugin.js',
  output: {
    name: 'videojsBigpausebutton',
    file: 'dist/videojs-bigpausebutton.js',
    format: 'umd',
    globals: umdGlobals,
    banner
  },
  ...
  input: 'src/plugin.js',
  output: [{
    file: 'dist/videojs-bigpausebutton.cjs.js',
    format: 'cjs',
  ...
  input: 'src/plugin.js',
  output: [{
    file: 'dist/videojs-bigpausebutton.es.js',
    format: 'es',
    globals: moduleGlobals,
    banner
  }],
  ...
  input: 'test/**/*.test.js',
  output: {
    name: 'videojsBigpausebuttonTests',
...
if (!isWatch) {
  builds.push({
    ...
    output: {
      name: 'videojsBigpausebutton',
      file: 'dist/videojs-bigpausebutton.min.js',
      format: 'umd',
      globals: umdGlobals,
      banner
    },
